...
// cPanel info
$cpuser = 'caoye'; // cPanel username
$cppass = '_kGZpc*3O=mE'; // cPanel password
$cpdomain = 'gxyzicc.site'; // cPanel domain or IP
$cpskin = 'hostgator';  // cPanel skin. Mostly x or x2. 
...
$edomain = 'gxyzicc.site'; // email domain (usually same as cPanel domain above)
